...
print("p-value bird & mammal: "+str(pval_1))
...
print("p-value reptile & mammal: "+str(pval_2))
...
ax1.set_xticks(range(len(obs_by_park.park_name)))
...
print("Bryce: " + str(bryce_weeks)+" weeks")
print("Yellowstone: "+str(round(yellowstone_weeks,2))+" weeks")
